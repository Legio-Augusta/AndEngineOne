...
public class PipePair {
	...
	float PIPE_WIDTH = FlappyBirdActivity.CAMERA_WIDTH * 0.18f;
	...
	private static final float PIPE_Y_OFFSET = FlappyBirdActivity.CAMERA_WIDTH + 200; // make sure they always spawn way off screen
