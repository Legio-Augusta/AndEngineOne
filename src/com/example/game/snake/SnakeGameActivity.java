...
import com.example.game.snake.adt.Direction;
import com.example.game.snake.adt.SnakeSuicideException;
import com.example.game.snake.entity.Frog;
import com.example.game.snake.entity.Snake;
import com.example.game.snake.entity.SnakeHead;
import com.example.game.snake.util.constants.SnakeConstants;
...
//		this.mFrog.animate(1000);
		...
		this.mScene.getChildByIndex(LAYER_FOOD).attachChild((IEntity) this.mFrog);
